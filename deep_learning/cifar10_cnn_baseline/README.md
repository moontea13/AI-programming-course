...
本项目是深度学习课程作业第一步：使用 PyTorch 和 torchvision 搭建一个可跑通的 CIFAR-10 图像分类 baseline。

## 实验目的

搭建一个结构简单、指标完整、结果可复现的 CNN baseline，明确 CIFAR-10 数据划分、训练设置、评价指标和输出文件，为后续调参和对比实验提供基准结果。
